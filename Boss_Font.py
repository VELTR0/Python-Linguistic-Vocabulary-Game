...
class BossFont:
    def __init__(self, font_path=None, *, space_width=6, trim=True):
        if font_path is None:
            font_path = r"Sprites\Boss\Font.png"
        ...
        *,
        ...
        for line in lines:
            ...
            for ch in line:
                ...
                # Align symbols to the bottom of the line
    ...
    def _extract_symbol(self, rect: pygame.Rect, *, row_height: int):
        ...
        if self.trim:
            symbol = self.trim_symbol_bottom_aligned(symbol, row_height)

        return symbol
    
    def trim_symbol_bottom_aligned(self, surf: pygame.Surface, row_height: int):
        """Trim symbol horizontally and ensure bottom alignment"""
